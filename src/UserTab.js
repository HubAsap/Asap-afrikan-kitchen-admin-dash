...
function UserTab(props) {
  ...
  return (
    <>
      ...
      <div className="row">
        <div className="col-6 col-sm-6 col-md-8 col-lg-8 pl-5">
          <h5 className="fw-bold pl">Users</h5>
          <p className="pl custom-muted-text">Manage your users</p>
        </div>
      ...
      <div className="shadow-sm p-4 h-50 bg-white rounded border border-1 rounded-4">
          ...
          <div className="col-md-2 col-sm-6 col-6 mt-2">
            <div className="form-group ">
              ...
              <select
                ...
                className="form-select form-item-height"
              >
          ...
          <div className="col-md-2 col-sm-6 col-6 mt-2">
            <div className="form-group">
              ...
              >
                ...
                <option value={"2"}>Email Un-Verified</option>
                <option value={"3"}>All Registered Today</option>
                <option value={"4"}>Only Males</option>
                <option value={"5"}>Only Females</option>
              </select>
            </div>
          </div>
        ...
        <br />
        <div className="table-responsive mt4" ref={pdfContentRef}>
                ...
                <tr key={customer.id}>
                  ...
                  <td scope="col" className="align-middle">
                    ...
                    <span style={{ color: "#555555", fontSize: "14px" }}>
                      Joined {customer.regdate.split(" ")[0]}
                    </span>
                  </td>
                  <td scope="col" className="align-middle">
                    {customer.email}
                  ...
                  <td
                    ...
                    data-toggle="tooltip"
                    data-placement="top"
                    title={customer.gender === "m" ? "Male" : "Female"}
                    align="center"
